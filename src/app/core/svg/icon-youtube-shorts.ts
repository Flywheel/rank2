...
@Component({
  selector: 'mh5-icon-youtube-shorts',
  standalone: true,
  imports: [],
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -8 32 32" width="24" fill="#CCF">
      <path
...
export class IconYouTubeShortsComponent {}
