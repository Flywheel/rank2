...
import { Asset, AssetView, Folio, FolioView, Placement, PlacementView } from '@shared/models/interfaces';
import { assetInit, assetViewInit, folioInit, folioViewInit, placementInit } from '@shared/models/initValues';
